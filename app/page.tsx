...
// ─── Keep CMS alive ───────────────────────────────────────
useEffect(() => {
  fetch(`${CMS_URL}/api/services?limit=1`).catch(() => {})
    ...
    <main className="min-h-screen" style={{ background: "#080808", color: "#e8e2d9", fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── Services ── */
       .services-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1px; background: var(--obsidian); }
        ...
        /* ── Testimonials ── */
        .testimonials-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1px; background: var(--obsidian); }
        ...
        /* ── Gallery ── */
        .gallery-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 2px; background: var(--surface); }
